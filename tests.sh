...
run_significant_digits_test_cases_integer_addition_and_subtraction()
{
	...
	assert_is_equal 0 3141592653589799323 "3141592653589799323"
...
run_significant_digits_test_cases_integer_multiplication_and_division()
{
	...
	assert_is_equal 0 31415926535897993 "31415926535897993 x 1"
	assert_is_equal 0 3.1415926535897993e+21 "3141592653589799323846 * 1"
...
{
	# additions and subtractions of floats: 16 significant digits
	...
	assert_is_equal 0 3141592653589799 "0.0 + 3141592653589799"
	assert_is_equal 0 3.141592653589799e+16 "31415926535897994 - 1.0"
	assert_is_equal 0 3.1415926535898e+19 "31415926535897994000.0 + 1000"
	assert_is_equal 0 3.141592653589799e+22 "31415926535897994699999.0 + 1"

	assert_is_equal 0 9.876543210987654e+18 "9876543210987654422.0 - 1 + 1"
	assert_is_equal 0 9.876543210987655e+19 "1.0 + 98765432109876545419"
	assert_is_equal 0 9.876543210987655e+22 "10.0 +  98765432109876546519000"
	assert_is_equal 0 9.876543210987655e+25 "98765432109876548690000000 - 10.00"
...
run_significant_digits_test_cases_float_multiplication_and_division()
{
	...
	assert_is_equal 0 3.14159265359e+13 "31415926535897 * 1.0"

	assert_is_equal 0 3.141592653586e+15 "3141592653585799 / 1.0"
	assert_is_equal 0 3.141592653585e+16 "31415926535845993*2.0 / 2.0"
	assert_is_equal 0 3.14159265358e+22  "31415926535804799323846 * 1.0"

	assert_is_equal 0 9.876543210988e+18 "9876543210987654322 * 1.0"
	assert_is_equal 0 9.876543210988e+19 "1 x 98765432109875543419.0"
	assert_is_equal 0 9.876543210987e+22 "1.0 * 98765432109874543519000"
	assert_is_equal 0 9.876543210987e+25 "1.0 x 98765432109872543690000000"
	assert_is_equal 0 9.876543210987e+30 "1.0 * 9876543210987054399999999999999"
}
