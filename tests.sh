...
{
	assert_is_equal 1 "whatis: missing elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information."
	assert_is_equal 1 "whatis: missing elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." ""
	assert_is_equal 1 "whatis: missing elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." " "
	assert_is_equal 1 "whatis: missing elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "  "

	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \"\"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \" \"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \"  \"
}
...
function run_expression_buffer_test_cases()
{
	...
	assert_is_equal 1 "Expression buffer too small." "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+12345678"
	...
	assert_is_equal 0 1481481595 "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123 +  4"
	assert_is_equal 1 "Expression buffer too small." "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123 + 04"
	assert_is_equal 1 "Expression buffer too small." "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+1+ 2 + 3"
	assert_is_equal 1 "Expression buffer too small." "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+1+ 2 + 3 +"

	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+123456789+1 + 2 +"
}
...
function run_read_expression_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[(1+2)*3-0.2]/2 0x3"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[(1+2)*3-0 .2]/20x3"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[(1+2)*3-0. 2]/20x3"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[(1+2)*3-0 . 2]/20x3"
}
...
function run_help_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \" --help\"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \"--help \"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \" --help \"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." \"--help ignored\"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "1+1 --help"
}
...
function run_bad_expression_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "++1"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "3++14"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "101a"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "1 4"
}
...
function run_brackets_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "2*[3+4"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "2*3+4]"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[[10+2]/6"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "[10+2]/6]"
}
...
function run_unary_operator_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "++7"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "--1"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "-  1 00"
	# Some parsers, like those in Python and JavaScript, consider "3 + +7" and "50 + -45" to be legal expressions.
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "3 + +7"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "50 + -45"
}

function run_xX_test_cases()
{
	assert_is_equal 0 21 "7x3"
	assert_is_equal 0 21 "7X3"
}
...
function run_one_number_test_cases()
{
	...
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." "..1"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." ".1."
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." ".1415."
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." ".14.15"
	assert_is_equal 1 "whatis: invalid elementary arithmetic expression"$'\n'"Try 'whatis --help' for more information." ".14.1.5."
}
